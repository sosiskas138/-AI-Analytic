...
const CALLS_ALIASES: Record<string, string> = {
  ...
  duration_seconds: "duration_seconds", Duration: "duration_seconds", "Длительность": "duration_seconds", "Длительность (мин:сек)": "duration_seconds", "Длительность (сек)": "duration_seconds",
  duration_minutes: "duration_minutes", "Длительность (мин)": "duration_minutes", "Minutes": "duration_minutes", "Минуты": "duration_minutes",
